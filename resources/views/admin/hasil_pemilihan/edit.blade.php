    ...
    <div class="content-wrapper">
        ...
        <section class="content">
            <div class="box">
                ...
                <form action="{{ url('/' . Request::segment(1) . '/edit/' . Crypt::encrypt($pendukung->id)) }}" method="POST" enctype="multipart/form-data" class="form-horizontal">
                    {{ csrf_field() }}
                        ...
                        <div class="col-lg-12">
                            ...
                            <div class="form-group @if ($errors->has('support_teams_family_card_number')) has-error @endif">
                                ...
                                <div class="col-sm-10">
                                    ...
                                    <input type="text" class="form-control" placeholder="No. KK" name="support_teams_family_card_number" value="{{ $pendukung->support_teams_family_card_number }}">
                                    <input type="hidden" class="form-control" placeholder="No. KK" name="support_teams_family_card_number" value="{{ $pendukung->support_teams_family_card_number }}">
                                </div>
                            </div>
                            ...
                            <div class="form-group @if ($errors->has('support_teams_id_number')) has-error @endif">
                                ...
                                <div class="col-sm-10">
                                    ...
                                    <input type="text" class="form-control" placeholder="NIK" name="support_teams_id_number" value="{{ $pendukung->support_teams_id_number }}">
                                </div>
                            </div>
                            ...
                            <div class="form-group @if ($errors->has('support_teams_name')) has-error @endif">
                                ...
                                <div class="col-sm-10">
                                    ...
                                    <input type="text" class="form-control" placeholder="Nama Lengkap" name="support_teams_name" value="{{ $pendukung->support_teams_name }} ">
                                </div>
                            </div>
                            ...
                            <div class="form-group @if ($errors->has('support_teams_place_of_birth')) has-error @endif">
                                ...
                                <div class="col-sm-10">
                                    ...
                                    <input type="text" class="form-control" placeholder="Tempat Lahir" name="support_teams_place_of_birth" value="{{ $pendukung->support_teams_place_of_birth }}">
                                </div>
                            </div>
                            ...
                            <div class="form-group @if ($errors->has('support_teams_date_of_birth')) has-error @endif">
                                ...
                                <div class="col-sm-10">
                                    ...
                                    <div class="input-group date">
                                        ...
                                        <input type="text" class="form-control datepicker" placeholder="Tanggal Lahir" name="support_teams_date_of_birth" value="{{ $pendukung->support_teams_date_of_birth }}">
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="form-group @if ($errors->has('support_teams_gender')) has-error @endif">
                                ...
                                <div class="col-sm-10">
                                    ...
                                    <select class="form-control select2" name="support_teams_gender">
                                        ...
                                        <option value="Pria" @if ($pendukung->support_teams_gender == 'Pria') selected @endif> Pria</option>
                                        <option value="Wanita" @if ($pendukung->support_teams_gender == 'Wanita') selected @endif> Wanita</option>
                            ...
                            <div class="form-group @if ($errors->has('jobs_id')) has-error @endif">
                                ...
                                <div class="col-sm-10">
                                    ...
                                    <select class="form-control" name="jobs_id" >
                                        ...
                                        @foreach($jobs as $v)
                                        <option value="{{ $v->id }}" @if($pendukung->jobs_id==$v->id) selected @endif>{{ $v->jobs_name}}</option>
                                        @endforeach
                                    </select>
                            ...
                            <div class="form-group @if ($errors->has('support_teams_address')) has-error @endif">
                                ...
                                <div class="col-sm-10">
                                    ...
                                    <textarea class="form-control" placeholder="Alamat" name="support_teams_address">{{ $pendukung->support_teams_address }}</textarea>
                                </div>
                            </div>
                            ...
                            <div class="form-group @if ($errors->has('subdistricts_id')) has-error @endif">
                                ...
                                <div class="col-sm-10">
                                    ...
                                    <select class="form-control" name="subdistricts_id" id="subdistricts_id" onChange="tampil_kelurahan();">
                                        ...
                                        <option value="{{ $v->id }}" @if($pendukung->subdistricts_id==$v->id) selected @endif>{{ $v->subdistricts_name}}</option>
                                        @endforeach
                                    </select>
                            ...
                            <div class="form-group @if ($errors->has('support_teams_rt')) has-error @endif">
                                ...
                                <div class="col-sm-10">
                                    ...
                                    <select class="form-control select2" name="support_teams_rt">
                                        ...
                                        <option value="001" @if ($pendukung->support_teams_rt == '001') selected @endif> 001</option>
                                        <option value="002" @if ($pendukung->support_teams_rt == '002') selected @endif> 002</option>
                                        <option value="003" @if ($pendukung->support_teams_rt == '003') selected @endif> 003</option>
                                        <option value="004" @if ($pendukung->support_teams_rt == '004') selected @endif> 004</option>
                                        <option value="005" @if ($pendukung->support_teams_rt == '005') selected @endif> 005</option>
                                    </select>
                            ...
                            <div class="form-group @if ($errors->has('support_teams_rw')) has-error @endif">
                                ...
                                <div class="col-sm-10">
                                    ...
                                    <select class="form-control select2" name="support_teams_rw">
                                        ...
                                        <option value="001" @if ($pendukung->support_teams_rw == '001') selected @endif> 001</option>
                                        <option value="002" @if ($pendukung->support_teams_rw == '002') selected @endif> 002</option>
                                        <option value="003" @if ($pendukung->support_teams_rw == '003') selected @endif> 003</option>
                                        <option value="004" @if ($pendukung->support_teams_rw == '004') selected @endif> 004</option>
                                        <option value="005" @if ($pendukung->support_teams_rw == '005') selected @endif> 005</option>
                                    </select>
                            ...
                            <div class="form-group @if ($errors->has('support_teams_cellphone')) has-error @endif">
                                ...
                                <div class="col-sm-10">
                                    ...
                                    <input type="text" class="form-control" placeholder="Nomor HandPhone" name="support_teams_cellphone" value="{{ $pendukung->support_teams_cellphone }} ">
                                </div>
                            </div>

                            <div class="form-group @if ($errors->has('support_teams_must_choose')) has-error @endif">
                                <label class="col-sm-2 control-label">{{ __('Jumlah Wajip Pilih Dalam Rumah') }} <span class="required" style="color: #dd4b39;">*</span></label>
                                <div class="col-sm-10">
                                    ...
                                    <input type="text" class="form-control" placeholder="Jumlah Wajip Pilih Dalam Rumah" name="support_teams_must_choose" value="{{ $pendukung->support_teams_must_choose }} ">
                                </div>
                            </div>
