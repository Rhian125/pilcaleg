...
<section class="content-header">
	...
	<div class="box">
		<div class="box-header with-border">
			<h3 class="box-title">Tambah Menu Acccess</h3>
		</div>
			...
			<div class="box-body">
				<div class="col-lg-12">
					...
					<div class="form-group @if ($errors->has('menu_id')) has-error @endif">
						<label class="col-sm-2 control-label">Menu <span class="required" style="color: #dd4b39;">*</span></label>
						<div class="col-sm-10">
