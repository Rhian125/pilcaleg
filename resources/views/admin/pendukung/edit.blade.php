    ...
    <div class="content-wrapper">
        ...
        <section class="content">
            <div class="box">
                ...
                <form action="{{ url('/' . Request::segment(1) . '/edit/' . Crypt::encrypt($relawan->id)) }}" method="POST" enctype="multipart/form-data" class="form-horizontal">
                    {{ csrf_field() }}
                        ...
                        <div class="col-lg-12">
                            ...
                            <div class="form-group @if ($errors->has('volunteers_id_number')) has-error @endif">
                                ...
                                <div class="col-sm-10">
                                    ...
                                    <input type="text" class="form-control" placeholder="NIK" name="volunteers_id_number" value="{{ $relawan->volunteers_id_number }}">
                                    <input type="hidden" class="form-control" placeholder="NIK" name="volunteers_id_number2" value="{{ $relawan->volunteers_id_number }}">
                                </div>
                            </div>
                            ...
                            <div class="form-group @if ($errors->has('volunteers_name')) has-error @endif">
                                ...
                                <div class="col-sm-10">
                                    ...
                                    <input type="text" class="form-control" placeholder="Nama Lengkap" name="volunteers_name" value="{{ $relawan->volunteers_name }} ">
                                </div>
                            </div>
                            ...
                            <div class="form-group @if ($errors->has('volunteers_place_of_birth')) has-error @endif">
                                ...
                                <div class="col-sm-10">
                                    ...
                                    <input type="text" class="form-control" placeholder="Tempat Lahir" name="volunteers_place_of_birth" value="{{ $relawan->volunteers_place_of_birth }}">
                                </div>
                            </div>
                            ...
                            <div class="form-group @if ($errors->has('volunteers_date_of_birth')) has-error @endif">
                                ...
                                <div class="col-sm-10">
                                    ...
                                    <div class="input-group date">
                                        ...
                                        <input type="text" class="form-control datepicker" placeholder="Tanggal Lahir" name="volunteers_date_of_birth" value="{{ $relawan->volunteers_date_of_birth }}">
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="form-group @if ($errors->has('volunteers_gender')) has-error @endif">
                                ...
                                <div class="col-sm-10">
                                    ...
                                    <select class="form-control select2" name="volunteers_gender">
                                        ...
                                        <option value="Pria" @if ($relawan->volunteers_gender == 'Pria') selected @endif> Pria</option>
                                        <option value="Wanita" @if ($relawan->volunteers_gender == 'Wanita') selected @endif> Wanita</option>
                            ...
                            <div class="form-group @if ($errors->has('jobs_id')) has-error @endif">
                                ...
                                <div class="col-sm-10">
                                    ...
                                    <select class="form-control" name="jobs_id" >
                                        ...
                                        @foreach($jobs as $v)
                                        <option value="{{ $v->id }}" @if($relawan->jobs_id==$v->id) selected @endif>{{ $v->jobs_name}}</option>
                                        @endforeach
                                    </select>
                            ...
                            <div class="form-group @if ($errors->has('volunteers_address')) has-error @endif">
                                ...
                                <div class="col-sm-10">
                                    ...
                                    <textarea class="form-control" placeholder="Alamat" name="volunteers_address">{{ $relawan->volunteers_address }}</textarea>
                                </div>
                            </div>
                            ...
                            <div class="form-group @if ($errors->has('subdistricts_id')) has-error @endif">
                                ...
                                <div class="col-sm-10">
                                    ...
                                    <select class="form-control" name="subdistricts_id" id="subdistricts_id" onChange="tampil_kelurahan();">
                                        ...
                                        <option value="{{ $v->id }}" @if($relawan->subdistricts_id==$v->id) selected @endif>{{ $v->subdistricts_name}}</option>
                                        @endforeach
                                    </select>
                            ...
                            <div class="form-group @if ($errors->has('volunteers_rt')) has-error @endif">
                                ...
                                <div class="col-sm-10">
                                    ...
                                    <select class="form-control select2" name="volunteers_rt">
                                        ...
                                        <option value="001" @if ($relawan->volunteers_rt == '001') selected @endif> 001</option>
                                        <option value="002" @if ($relawan->volunteers_rt == '002') selected @endif> 002</option>
                                        <option value="003" @if ($relawan->volunteers_rt == '003') selected @endif> 003</option>
                                        <option value="004" @if ($relawan->volunteers_rt == '004') selected @endif> 004</option>
                                        <option value="005" @if ($relawan->volunteers_rt == '005') selected @endif> 005</option>
                                    </select>
                            ...
                            <div class="form-group @if ($errors->has('volunteers_rw')) has-error @endif">
                                ...
                                <div class="col-sm-10">
                                    ...
                                    <select class="form-control select2" name="volunteers_rw">
                                        ...
                                        <option value="001" @if ($relawan->volunteers_rw == '001') selected @endif> 001</option>
                                        <option value="002" @if ($relawan->volunteers_rw == '002') selected @endif> 002</option>
                                        <option value="003" @if ($relawan->volunteers_rw == '003') selected @endif> 003</option>
                                        <option value="004" @if ($relawan->volunteers_rw == '004') selected @endif> 004</option>
                                        <option value="005" @if ($relawan->volunteers_rw == '005') selected @endif> 005</option>
                                    </select>
                            ...
                            <div class="form-group @if ($errors->has('volunteers_cellphone')) has-error @endif">
                                ...
                                <div class="col-sm-10">
                                    ...
                                    <input type="text" class="form-control" placeholder="Nomor HandPhone" name="volunteers_cellphone" value="{{ $relawan->volunteers_cellphone }} ">
                                </div>
                            </div>
